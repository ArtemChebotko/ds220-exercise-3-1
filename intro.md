     ...
     <div class="row g-4 py-2 row-cols-1 row-cols-lg-1">
      <div class="feature col div-choice">
            ...
            <ul>
              ...
              <li><span class="scenario-objective">Create a user defined type</span></li>
              <li><span class="scenario-objective">Alter an existing table and add additional columns</span></li>
            </ul>
      </div>
     </div>
    </div>
    <div class="container px-4 py-2">
        ...
        <div class="row g-4 py-2 row-cols-1 row-cols-lg-1">
          <div class="feature col div-choice">
            ...
            <div class="cassandra-line2">You will use a Cassandra cluster deployed locally in Gitpod</div>
            <br/>
